...
public class KThread {
    ...
    public static void finish() {
        System.out.println("FINISH CALLLEDDDD");
    ...
    public void join() {
        ...
        /*
         * funcs in KThread: target is the runnable that actually runs fork();
         * runThread();
         * 
         * begin(); finish(); yield(); sleep(); ready();
         * 
         * join();
         * 
         * 
        ...
        // the 5 statuses are statusNew, statusReady, statusRunning, statusBlocked,
        // statusFinished
    ...
    public void wakeSleepingThread() {
